...
* Alternatively, a way of estimating a wiggly surface to account for latent or unobserved spatially structured variables.

--

* As a bonus, it provides useful covariance parameter estimates: spatial variance and the rate at which data become uncorrelated with distance
...
See `spatial-pacific/01-spatial-dmvnorm-exercise.R`.
...
* For autoregressive fields:
  * Same reasons as for IID fields, plus:
